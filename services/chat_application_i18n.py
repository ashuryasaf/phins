...
STEP_PROMPTS_HE: Dict[str, str] = {
    ...
    "country": (
        "אומת — תודה! לאן לשלוח את מסמכי הפוליסה? "
        "התחילו להקליד את שם המדינה."
    ),
    "city": "ואיזו עיר?",
    "dob": (
        "עכשיו חלק החיתום. אהיה הסוכן/ת שלך לאורך הדרך: "
...
MSG_HE: Dict[str, str] = {
    ...
    "otp_challenge": (
        "מושלם. כדי להגן על הנתונים שלך אשלח קוד אימות בן 6 ספרות אל "
        "{masked_email}, ב-SMS {masked_phone}, או לוואטסאפ {masked_phone}. "
        "בחרו דוא\"ל, SMS או וואטסאפ למטה, ואז הקלידו את הקוד כשיגיע."
    ),
    "ready_to_finalize": (
